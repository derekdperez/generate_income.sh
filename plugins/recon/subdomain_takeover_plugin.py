...
class ReconSubdomainTakeoverPlugin(CoordinatorPlugin):
    plugin_name = "recon_subdomain_takeover"

    def run(self, context: PluginExecutionContext) -> RunResult:
        return context.coordinator._run_recon_subdomain_takeover_plugin_task(

...
<body>
  ...
  <div class="meta">Shows current PostgreSQL status, all non-system tables, and full contents of each table. <a href="/dashboard">Dashboard</a> Â· <a href="/workers">Workers</a></div>
  <div class="toolbar">
  ...
  <div id="tables"><div class="empty">Loadingâ€¦</div></div>
  <script>
    function esc(v) {
    ...
    function renderTables(data) {
      ...
      document.getElementById("tables").innerHTML = tables.map((t) => {
        ...
        return `<section class="tableCard">
          <div class="tableHead"><strong>${esc(t.schema)}.${esc(t.name)}</strong> Â· ${esc(t.row_count)} row(s)</div>
          <div class="tableBody">

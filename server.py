...
class DashboardHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:  # noqa: N802
        ...
        if path == "/workers":
            ...
            return
        if path == "/database":
            self._write_text(self._render_database_html(), content_type="text/html; charset=utf-8")
            return
        if path == "/api/summary":
...
<body>
  ...
  <div class="meta">Asynchronous auto-refresh every 3s. Use row selection to run bulk start/stop/pause commands. <a href="/dashboard">Back to Dashboard</a> · <a href="/database">Database Status</a></div>
  <div id="cards" class="cards"></div>
  <div class="toolbar">
